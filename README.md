...
Para el desarrollo de este proyecto se utilizó [Devin](https://devin.ai/) como asistente de inteligencia artificial para la escritura, depuración y documentación del código.
